...
namespace Assessment_1_Scripts.Player
{
    public class ADDED_DASH : MonoBehaviour
    {
        ...
        [Header("Semi-Solids")]
        //how long the player ignores the relaxed semi-solid dropping through it
        [SerializeField]
        [Range(0.5f, 1)]
        private float m_PlatformIgnoreTime = 0.5f;
        ...
        private IEnumerator C_DropThroughPlatform(Collider2D platformCollider)
        {
            ...
            yield return new WaitForSeconds(m_PlatformIgnoreTime);
