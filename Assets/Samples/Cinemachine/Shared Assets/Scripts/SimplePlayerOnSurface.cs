...
namespace Unity.Cinemachine.Samples
{
    ...
    public class SimplePlayerOnSurface : MonoBehaviour
    {
        ...
        [Header("Events")] [Tooltip("This event is sent when the player moves from one surface to another.")]
        ...
        void LateUpdate()
        {
            ...
            var raycastLength = Mathf.Max(MaxRaycastDistance, PreviousSateIsValid
                ? (m_PreviousGroundPoint - downRaycastOrigin).magnitude + PlayerHeight
                : MaxRaycastDistance);
            ...
            if (!haveHit && PreviousSateIsValid
                         && UnityEngine.Physics.Raycast(downRaycastOrigin, m_PreviousGroundPoint - downRaycastOrigin,
                             out hit,
