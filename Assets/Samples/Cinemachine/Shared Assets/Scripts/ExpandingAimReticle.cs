...
namespace Unity.Cinemachine.Samples
{
    ...
    {
        [Tooltip("Maximum radius of the aim reticle, when aiming is inaccurate. ")] [Vector2AsRange]
        public Vector2 RadiusRange;

        [Tooltip("The time is takes for the aim reticle to adjust, when inaccurate.")] [Range(0, 1f)]
        ...
        void Update()
        {
            ...
            m_CurrentRadius =
                Mathf.SmoothDamp(m_CurrentRadius, distanceFromCenter * 2f, ref m_BlendVelocity, BlendTime);
